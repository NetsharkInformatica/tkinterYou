...
class Downloader:
    ...
    def __init__(self):
        ...
        self.img_logo = PhotoImage(file="youlogo.png")
        ...
        self.link = Entry(self.frame2, font="arial 20", width=40)
    ...
    def complete(self):
        ...
        text = Label(window, text="app sempre gratuito\nCortesia de Hélio Tomé", pady=30)
        text.pack()
